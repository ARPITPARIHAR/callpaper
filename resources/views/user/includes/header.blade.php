...
<div class="row" style="margin-top:5px;">
    ...
    <div class="col-sm-6 mb-4">
        <div class="service-container" style="background: linear-gradient(-225deg, rgb(40 79 117) 17%, rgb(40 79 117) 92%) !important; border-left: 10px solid rgb(237, 221, 131); border-bottom: 10px solid rgb(61, 217, 194);">
            <i class="fas fa-newspaper newspaper-icon" alt="integrated-marketing" data-aos="zoom-in"
            style="font-size: 40px; color: white;"></i>
         <h5 class="text-white mb-2 mt-3 font-weight-medium">Journal Publication Support:</h5>
<p class="text-white mt-2 mb-0">
                Struggling to articulate your research findings effectively? Our expert writers are here to help. Whether you need assistance with drafting a compelling abstract, refining your methodology, or polishing your language, we provide tailored support to help you communicate your ideas with clarity and precision.
            </p>
        </div>
    </div>
    ...
    <div class="col-lg-6 col-md-12 mb-4">
        <div class="service-container" style="background: linear-gradient(-225deg, rgb(40 79 117) 17%, rgb(40 79 117) 92%) !important; border-left: 10px solid rgb(237, 221, 131); border-bottom: 10px solid rgb(61, 217, 194);">
            <i class="fas fa-pencil-alt pencil-icon" data-aos="zoom-in"
            style="font-size: 40px; color: white;"></i>
         <h5 class="text-white mb-2 mt-3 font-weight-medium">Paper Writing Assistance</h5>
 <p class="text-white mt-2 mb-0">
                Our experienced team is dedicated to guiding you through every step of the journal publication process. From manuscript preparation to submission, peer review, and final publication, we offer personalized assistance to ensure your work meets the highest standards of academic excellence.
            </p>
        </div>
    </div>
    ...
    <div class="col-lg-6 col-md-12 mb-4">
        <div class="service-container" style="background: linear-gradient(-225deg, rgb(40 79 117) 17%, rgb(40 79 117) 92%) !important; border-left: 10px solid rgb(237, 221, 131); border-bottom: 10px solid rgb(61, 217, 194);">
            <i class="fas fa-book book-icon" data-aos="zoom-in"
                           style="font-size: 40px; color: white;"></i>
                           <h5 class="text-white mb-2 mt-3 font-weight-medium" >Book Publishing Services</h5>
            <p class="text-white mt-2 mb-0">
                Ready to share your expertise with the world? Our book publishing services empower authors to transform their research into impactful publications. From manuscript editing and formatting to cover design and distribution, we offer end-to-end support to help you bring your book to life.
            </p>
        </div>
    </div>
    ...
    <div class="col-lg-6 col-md-12 mb-4">
        <div class="service-container" style="background: linear-gradient(-225deg, rgb(40 79 117) 17%, rgb(40 79 117) 92%) !important; border-left: 10px solid rgb(237, 221, 131); border-bottom: 10px solid rgb(61, 217, 194);">
            <i class="fas fa-book book-icon" data-aos="zoom-in"
                           style="font-size: 40px; color: white;"></i>
                           <h5 class="text-white mb-2 mt-3 font-weight-medium" >Citation Increase Support</h5>
            <p class="text-white mt-2 mb-0">
                Boosting your citation count is essential for increasing the visibility and impact of your research. Our team employs strategic techniques to enhance the discoverability of your work, including targeted promotion, networking opportunities, and citation tracking tools.
            </p>
        </div>
    </div>
    ...
    {{-- <div class="col-lg-6 col-md-12 mb-4">
        <div class="service-container" style="background: linear-gradient(-225deg, rgb(40 79 117) 17%, rgb(40 79 117) 92%) !important; border-left: 10px solid rgb(237, 221, 131); border-bottom: 10px solid rgb(61, 217, 194);">
            <i class="fas fa-chart-line chart-icon" data-aos="zoom-in"
...
.service-container {
    padding: 20px !important; /* सुनिश्चित करें कि कंटेनर के अंदर सही स्पेस हो */
    margin: 0 !important; /* कंटेनर के बाहर स्पेस को हटा दें */
    box-sizing: border-box !important;
    width: 100%; /* पूरे कंटेनर की चौड़ाई को कवर करें */
}

.service-container p {
    margin: 0 !important; /* `p` टैग के बाहर का मार्जिन हटाएं */
    padding: 0 !important; /* `p` टैग के अंदर का पेडिंग हटाएं */
    text-align: justify; /* टेक्स्ट को पूरे कंटेनर में फैलाएं */
    line-height: 1.5; /* लाइन स्पेस को संतुलित करें */
    width: 100%; /* `p` टैग की चौड़ाई पूरे कंटेनर को कवर करें */
    box-sizing: border-box; /* बॉर्डर और पेडिंग को शामिल करें */
}

.elementor-34 .elementor-element.elementor-element-6258cda .elementor-heading-title {
...
/* Custom CSS for the heading */
h5.custom-heading {
    font-family: 'Poppins', sans-serif; /* Clean, modern font family */
    font-weight: 600; /* Slightly bold to stand out */
    font-size: 28px; /* A comfortable size that’s neither too big nor too small */
    color: #fff; /* White color for the text to contrast nicely */
    background-color:red; /* A soft blue background */
    padding: 15px 30px; /* Adding more space inside the button for a larger feel */
    border-radius: 50px; /* Rounded corners for a modern look */
    text-transform: none; /* Avoiding uppercase to make it more readable */
    letter-spacing: 1px; /* Light letter-spacing for elegance */
    text-align: center; /* Center aligned */
    display: inline-block; /* Keeps the heading inline */
    box-shadow: 0 6px 12px rgba(0, 0, 0, 0.1); /* Light shadow for depth */
    transition: background-color 0.3s ease, transform 0.3s ease; /* Smooth transition for interaction */
}
...
<section class="our-process" id="about" style="margin-top: -105px;">

        <div class="row justify-content-center">
            <div class="col-sm-12 text-center">
                <div class="elementor-widget-container">
                    <h2 class="elementor-heading-title elementor-size-default">Our Work Process</h2>
                </div>
            </div>
        </div>
        <div class="row align-items-center">
            ...
            <div class="col-sm-6" data-aos="fade-up">
                <div class="container" style="background-color: #FDCF08; padding: 20px; border-radius: 10px;">
                <p style="font-size: 20px; line-height: 1.1; font-family: 'g-bk'; color: #000;">
                    Welcome to Scholarlypublishing, your comprehensive support platform for academic publishing and citation enhancement!
                </p>
                <p style="font-size: 20px; line-height: 1.1; font-family: 'g-bk'; color: #000;">
                    At Scholarlypublishing, we understand the challenges researchers and academics face in navigating the complex world of scholarly publishing. Whether you're a seasoned scholar or a budding researcher, our mission is to provide you with the tools and support you need to excel in your academic journey.
                </p>
            </div>
        </div>
            <!-- Right Column -->
            <div class="col-sm-6 text-right" data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="2000">
                <img src="images/idea.png" alt="idea" class="img-fluid" style="max-width: 100%; border-radius: 10px;">
            </div>
        </div>
    </div>
</section>
...
<section class="our-projects" id="choose" style="margin-top: =250px;">
    <div class="container">
        <div class="row">
...
<div class="row justify-content-center">
            <div class="col-sm-12 text-center">
                <h2 class="elementor-heading-title elementor-size-default">Our Selection View</h2>
            </div>
        </div>
        <div class="journal-info" style="background-color: #013DC0; padding: 20px; border-radius: 10px;">
            <p style="font-size:18px;    color: #fcfcfc;
    font-family:inherit;
    font-weight: 100;  color: white; padding: 15px; border-radius: 10px; border-top: 1px solid white; border-bottom: 1px solid white; border-left: 1px solid white; border-right: 1px solid white;">
                At <span class="journal-name" style="color: white;">Scholarlypublish</span>, we recognize that the journey of academic publishing can be daunting. With countless options available, it's crucial to partner with a support platform that not only understands your unique needs but also empowers you to achieve your academic aspirations. Here's why Scholarlypublish stands out:
            </p>
        </div>

            </div>
            <!-- List Items Columns -->
            <div class="col-sm-6" data-aos=fade-right" style="margin-top: 20px;">
                <div class="journal-info" style="background-color: #fd5f00 ; border-radius: 15px; padding: 20px;color:white;">
                    <h4 style="text-align: center;">Unparalleled Expertise</h3>
                    <hr style="border-top: 2px solid #000;">
                    <ul style="font-size: 18px; line-height: 1.6; font-family: 'Rubik', sans-serif;">
                        <li>Backed by a team of seasoned professionals with extensive experience in academic publishing, we bring a wealth of knowledge and expertise to the table. From navigating the intricacies of manuscript preparation to mastering the nuances of citation enhancement, we provide you with the guidance and support you need to succeed.</li>
                    </ul>
                </div>
            </div>
            <div class="col-sm-6" data-aos="fade-left" style="margin-top: 20px;">
                <div class="journal-info" style="background-color:#0d1128 ; border-radius: 15px; padding: 20px;color:white;">
                    <h4 style="text-align: center;">Tailored Solutions</h3>
                    <hr style="border-top: 2px solid white;">
                    <ul style="font-size: 18px; line-height: 1.6; font-family: 'Rubik', sans-serif;">
                        <li>We understand that every researcher and academic has distinct goals and challenges. That's why we take a personalized approach to our services, tailoring our support to align with your specific needs and objectives. Whether you're a first-time author or a seasoned scholar, we're here to provide you with the customized assistance you need to excel.</li>
                    </ul>
                </div>
            </div>
            <!-- Additional List Items Column -->
            <div class="col-sm-6" data-aos="fade-right" style="margin-top: 30px;">
                <div class="journal-info" style="background-color: #0d1128; border-radius: 15px; padding: 20px;color:white;">
                    <h4 style="text-align: center;">Commitment to Quality</h3>
                    <hr style="border-top: 2px solid white;">
                    <ul style="font-size: 18px; line-height: 1.6; font-family: 'Rubik', sans-serif;">
                        <li>At <span class="journal-name">scholarlypublish</span>, quality is our top priority. We are dedicated to upholding the highest standards of excellence in everything we do, from manuscript editing and peer review to book formatting and citation enhancement. When you choose <span class="journal-name">scholarlypublish</span>, you can trust that your work will receive the attention to detail it deserves.</li>
                    </ul>
                </div>
            </div>
            <div class="col-sm-6" data-aos="fade-left" style="margin-top: 30px;">
                <div class="journal-info" style="background-color: #fd5f00 ; border-radius: 15px; padding: 20px;color:white;">
                    <h4 style="text-align: center;">Comprehensive Support</h3>
                    <hr style="border-top: 2px solid #000;">
                    <ul style="font-size: 18px; line-height: 1.6; font-family: 'Rubik', sans-serif;">
                        <li>Our suite of services is designed to address every aspect of the academic publishing process, providing you with comprehensive support at every stage of your journey. Whether you're seeking assistance with journal publication, paper writing, book publishing, or citation increase, we offer the resources and expertise you need to achieve your goals.</li>
                    </ul>
                </div>
            </div>
        </div>
 ...
 <div class="journal-info" style="background-color: #013DC0; padding: 20px; border-radius: 10px;">
    ...
    font-family:inherit;
    font-weight: 100;  color: white; padding: 15px; border-radius: 10px; border-top: 1px solid white; border-bottom: 1px solid white; border-left: 1px solid white; border-right: 1px solid white;">
                 <span class="journal-name" style="color: white;">Choose</span>,scholarlypublish</span> as your trusted partner in academic publishing and citation enhancement. Join our community of researchers and academics who are dedicated to making a meaningful impact in their fields. With scholarlypublish</> by your side, the possibilities are endless.
            </p>
        </div>
...
<section class="our-projects" id="paper">
...
<div class="container" style="margin-top: -130px;">
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="col-sm-12 text-center">
                <h2 class="elementor-heading-title elementor-size-default">Submit Your Article</h2>
            </div>
...
<form action="{{ route('submit.article') }}" enctype="multipart/form-data" method="post" style="display: flex; flex-direction: column;">
    ...
    <div class="button-container">
        <button type="submit" class="button-ef more-btn more-btn1">Save</button>
        <input type="reset" class="button-ef more-btn more-btn1" value="Cancel">
    </div>
</form>
    ...
    <div class="container">
        <div class="row mb-5 pb-5">
            ...
            <div class="col-sm-7" data-aos="fade-up" data-aos-offset="-500">
                <div class="container">
                    <div class="row mb-5 pb-5">
                        <!-- Left column for "Got A Problem" section -->
                        <div class="col-sm-6" data-aos="fade-up" data-aos-offset="-500">
                        ...
                        <div class="col-sm-6 aos-animate" data-aos="zoom-in" data-aos-offset="-100">
                            <div class="contact-info-container" style="background-color:#046731; border-radius: 15px; padding: 20px;">
                                <p class="mb-0">
                ...
                <form method="POST" action="{{ route('submit.form') }}" id="your-form-id">
                    ...
                    <button type="submit" class="button-ef more-btn more-btn1">Submit</button>
                </form>
            </div>
...
.elementor-widget-container {
    padding: 25px 50px; /* Padding inside the container */
    border-radius: 50px 0px 50px 0px; /* Rounded corners for the container */
}

.elementor-heading-title {
    background-color:black; /* Blue background for the heading */
    color:yellow; /* Text color white */
    padding: 10px 20px; /* Padding around the heading text */
    border-radius: 50px 0px 50px 0px; /* Rounded corners for the heading */
    display: inline-block; /* Ensures the background only covers the heading text */
}



.news_articles .article_post h5 {
    color: #fcfcfc;
...
.news-post-title {
    font-size: 18px;
    line-height: 30px;
    margin: 0 0 10px 0 color: #333333;
    margin: 0 0 8px 0;
    letter-spacing: 1px;
    font-weight: bold;
}
...
.pencil-icon {
  color: #ff6347; /* Change the color to your desired color */
  font-size: 42px; /* Adjust the font size as needed */
}

.book-icon {
  color: #4682b4; /* Change the color to your desired color */
  font-size: 42px; /* Adjust the font size as needed */
}
...
.email-address {
  color: #ffffff; /* Set text color for email */
  text-decoration: none; /* Remove underline from email link */
  font-weight: 200; /* Add a touch of boldness */
}
...
<script>
  ...
  const scrollToContactForm = "{{ session('contactSuccess') && session('scrollToContactForm') ? true : false }}";

  // If session for scrolling to contact form exists, scroll to the contact form position
  if (scrollToContactForm) {
    const formSection = document.getElementById("contact");
    if (formSection) {
      const offset = formSection.getBoundingClientRect().top + window.scrollY - 450;
      window.scrollTo({ top: offset, behavior: "smooth" });
    }
  }
});
