      ...
      <div class="navbar-content scroll-div " >
          ...
          <div class="main-menu-header">
              ...
              <div class="user-details">
                  <span>ScholarlyPublishinghelp</span>
          ...
          <ul class="nav pcoded-inner-navbar ">
              ...
              <li class="nav-item">
                  <a href="/contact" class="nav-link "><span class="pcoded-micon"><i class="feather icon-map"></i></span><span class="pcoded-mtext">Contact</span></a>
              </li>
              <li class="nav-item pcoded-menu-caption">
                  <label>Pages</label>
              </li>
